...
namespace itmmti
{
  ...
  public:
    ...
    /*!
     * @brief Reduce Blocks and change "capacity_".
    ...
    (
     const size_t givenNumBlocks
      ...
      capacity_ = givenNumBlocks * kBlockSize;
    }
    ...
    (
     ...
     const bool verbose = false
      ...
      os << "kBlockSize = " << kBlockSize << ", size = " << this->size() << ", capacity = " << this->capacity() << std::endl;
